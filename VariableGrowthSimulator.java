...
/**
 VARIABLE GROWTH SIMULATION
 was done by Joelle Treasure using chat gpt to
 Debugging Help and code optimization suggestions.
 Improving My Code Readability and Structure.
 */
public class VariableGrowthSimulator {
    private static Scanner scanner = new Scanner(System.in);
   
    public static void main(String[] args) {
        System.out.println("===============================================");
        System.out.println("   ");
        System.out.println("    VARIABLE GROWTH SIMULATION ");
        System.out.println("    ");
        System.out.println("===============================================");
            ...
            try {
                ...
                switch (choice) {
                    ...
                    case 4:
                        ...
                        System.out.println("Thank you for using the Variable Growth Simulator!");
                        break;
                    default:
...
class VariableInvestmentCalculator {
...
class VariableInvestmentManager {
